...
const FOOTER_COLUMNS: FooterColumn[] = [
  {
    // This site's own pages — internal nav. Honest Ríkisborgarapróf, University of
    // Iceland & CEFR Icelandic practice; 25% of proceeds support the Shamool Foundation.
    title: "AlmiIcelandic",
    links: [
  ...
  },
  {
    ...
    title: "Products",
    links: footerProducts("icelandic"),
  },
  {
    title: "Legal & Contact",
    links: [
