...
export const JOBS_TOTAL = N_ROLE * N_COUNTRY * N_HUB; //    512 × 196 × 8 = 802,816
...
export const studyPath = (subjectSlug: string, countrySlug: string, uniSlug: string) =>
  `/study-in-iceland/${subjectSlug}/from/${countrySlug}/${uniSlug}`;
export const jobsPath = (roleSlug: string, countrySlug: string, hubSlug: string) =>
  `/work-in-iceland/${roleSlug}/from/${countrySlug}/${hubSlug}`;
