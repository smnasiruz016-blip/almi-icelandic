// Bundled item loader for AlmiIcelandic practice.
//
...
/** A single authored item, matching the IcelandicItem content fields (no DB id). */
export interface IcelandicItemSeed {
...
const BUNDLE_FILES = [
  "citizenship-reading.json",
  "citizenship-listening.json",
  "citizenship-productive.json",
  "university-reading.json",
  "university-listening.json",
  "university-productive.json",
  "cefr-a1.json",
  "cefr-a2.json",
  "cefr-b1.json",
  "cefr-b2.json",
...
function loadBundle(file: string): IcelandicItemSeed[] {
  try {
    ...
    return parsed as IcelandicItemSeed[];
  } catch {
...
let cache: IcelandicItemSeed[] | null = null;

function allItems(): IcelandicItemSeed[] {
