...
// WRITES prisma.icelandicItem.
//
// This endpoint used to count prisma.icelandicItem, inherited from an ancestor that seeded
...
import { getItems } from "@/lib/is/items";
...
export async function GET(): Promise<NextResponse> {
  ...
  return NextResponse.json(
    { ok: true, product: "almi-icelandic", itemsActive, items, approvedReviews, dbError },
