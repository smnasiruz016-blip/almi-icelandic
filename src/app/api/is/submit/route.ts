...
// Icelandic engine and echoes productive self-ratings. DB persistence of attempts is
...
import { gradeObjective } from "@/lib/is/grading";
import { isObjectiveTask, isFreeSkill } from "@/lib/is/types";
import type {
  ObjectiveAnswer,
  IcelandicSkill,
  IcelandicTaskType,
