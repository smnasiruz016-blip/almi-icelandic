...
import { MockRunner, type MockSection } from "@/components/is/MockRunner";
    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <header>
        ...
        <p className="mt-2 max-w-2xl text-sm text-almi-text">
          ...
          you get an overall estimate — not an official Directorate of Education or Ministry result.
        </p>
      </header>
