...
import { examBySlug, SKILL_LABELS } from "@/lib/is/registry";
import { isFreeSkill } from "@/lib/is/types";
import type { IcelandicSkill, IcelandicTrack } from "@/lib/is/types";

const TRACK_LABEL: Record<IcelandicTrack, string> = {
  CITIZENSHIP: "Citizenship — Ríkisborgarapróf",
  UNIVERSITY: "University of Iceland entrance",
  CEFR: "General Icelandic (CEFR)",
};
    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          {exam.skills.map((skill: IcelandicSkill) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-1 text-sm text-almi-text-muted">{label.is}</p>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm text-almi-text">
              ...
              never an official Directorate of Education or Ministry result.
            </p>
          </div>
      ...
      <p className="text-xs text-almi-text-muted">
        Original to AlmiIcelandic — never copied from official test material. Every readout is a
        practice estimate.
      </p>
    </div>
  );
