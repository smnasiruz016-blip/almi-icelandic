...
export const metadata: Metadata = {
  ...
  description:
    "AlmiIcelandic Pro — $12/month, cancel anytime. 7-day free trial. Honest AI feedback on writing and speaking, full-length practice, and honest readiness estimates for Ríkisborgarapróf, the University of Iceland entrance exam and the CEFR levels.",
};
...
const FEATURES = [
  ...
  "All three tracks — Ríkisborgarapróf (citizenship, A2), the University of Iceland entrance exam, and CEFR levels A1–C1",
